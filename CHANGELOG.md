## Release Note
### 2026.08.14 Version 2.9.19

- Fix PutObjectSetTagging 预期状态码错误

### 2026.08.13 Version 2.9.18

- Feat 视频转码支持去水印参数

### 2026.08.06 Version 2.9.17

- Feat 支持BucketTrash API
- Feat 支持Lifecycle NOT 参数

### 2026.06.08 Version 2.9.16

- Fix CopyObject/UploadPartCopy/FetchObject错误处理不正确
