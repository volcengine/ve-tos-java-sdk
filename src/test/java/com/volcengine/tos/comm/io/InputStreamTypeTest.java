...
public class InputStreamTypeTest {
    @Test
    void tosInputStreamTypeTest() throws ClassNotFoundException, FileNotFoundException {
        ...
        Assert.assertEquals(tis.getOriginInputStream().getClass(), Class.forName("com.volcengine.tos.comm.io.TosRepeatableInputStream$WrappedBufferedInputStream"));
    }
}
