...
import com.volcengine.tos.model.bucket.Delogo;
    ...
    public void videoConvertJobRequestSerializesDocumentedFields() throws Exception {
        VideoConvertJobRequest request = new VideoConvertJobRequest()
                ...
                .setTranscodeConfig(TranscodeConfig.builder()
                        ...
                        .delogos(Collections.singletonList(Delogo.builder()
                                .pos("BottomRight")
                                .locMode("Absolute")
                                .sizeMode("Fixed")
                                .dx(20)
        ...
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/Pos").asText(), "BottomRight");
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/LocMode").asText(), "Absolute");
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/SizeMode").asText(), "Fixed");
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/Dx").asInt(), 20);
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/Dy").asInt(), 30);
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/Width").asInt(), 200);
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/Height").asInt(), 100);
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/StartTime").asLong(), 1000L);
        Assert.assertEquals(body.at("/TranscodeConfig/Delogos/0/EndTime").asLong(), 5000L);
