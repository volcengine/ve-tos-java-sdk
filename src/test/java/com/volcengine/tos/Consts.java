...
public class Consts {
    ...
    public static final String vectorsEndpoint = System.getenv("TEST_VECTORS_ENDPOINT");
    ...
    public static final String acceleratorId = System.getenv("TEST_ACCELERATOR_ID");
    public static final String vpcId = System.getenv("TEST_VPC_ID");
