...
//    ModifyObjectOutput modifyObject(ModifyObjectInput input) throws TosException;
    ...
    /**
     * set the bucket trash configuration
     *
     * @param input set bucket name and bucket trash configuration
     * @return {@link PutBucketTrashOutput}
     * @throws TosException
     */
    PutBucketTrashOutput putBucketTrash(PutBucketTrashInput input) throws TosException;

    /**
     * get the bucket trash configuration
     *
     * @param input set bucket name
     * @return {@link GetBucketTrashOutput}
     * @throws TosException
     */
    GetBucketTrashOutput getBucketTrash(GetBucketTrashInput input) throws TosException;
