...
public class TranscodeConfig {
    ...
    @JsonProperty("Delogos")
    private List<Delogo> delogos;
    ...
    public List<Delogo> getDelogos() {
        return delogos;
    }

    public TranscodeConfig setDelogos(List<Delogo> delogos) {
    ...
    public static class TranscodeConfigBuilder {
        ...
        public TranscodeConfigBuilder delogos(List<Delogo> delogos) {
            this.delogos = delogos;
            return this;
        }
