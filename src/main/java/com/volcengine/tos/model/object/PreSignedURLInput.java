...
public class PreSignedURLInput {
    ...
    public static final class PreSignedURLInputBuilder {
        ...
        private boolean isCustomDomain;
        private boolean isSignedAllHeaders;
        private boolean isEncodingSlash;
        ...
        public PreSignedURLInputBuilder isEncodingSlash(boolean isEncodingSlash) {
            this.isEncodingSlash = isEncodingSlash;
            return this;
        }
        ...
        public PreSignedURLInput build() {
            ...
            preSignedURLInput.isEncodingSlash = this.isEncodingSlash;
            return preSignedURLInput;
        }
    }
}
