...
public class TOSV2Client implements TOSV2 {
    ...
    @Override
    public PutBucketTrashOutput putBucketTrash(PutBucketTrashInput input) throws TosException {
        return bucketRequestHandler.putBucketTrash(input);
    }

    @Override
    public GetBucketTrashOutput getBucketTrash(GetBucketTrashInput input) throws TosException {
        return bucketRequestHandler.getBucketTrash(input);
    }
